...
const products = [
  ...
  },
  {
    ...
    description: "This 100% organic and antiseptic soap has been produced for generations by a family of artisans in Quintana Roo using local products and traditions. Great as an everyday hand soap, but also recommended for acne, exfoliation, and oily skin.",
    price: 10,
    itemsRemaining: 0,
  ...
  }, 
  {
    ...
    name: "Calavera (skull)",
    category: "Home & Living",
    description: "Hand-painted by Mexican Artisans as part of Day of the Dead tradition of honoring the ancestors. Authentic hand-painted ceramic skulls created by artisans from Chiapas, Mexico.",
    price: 15,
    itemsRemaining: 2,
  }, 
  {
